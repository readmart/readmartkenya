    ...
    <div className="container mx-auto px-4 py-12 flex items-center justify-center min-h-[calc(100vh-200px)]">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">Login to your ReadMart account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              <label htmlFor="password" university-transition-colors="true" className="text-sm font-semibold">Password</label>
              <Link to="/forgot-password" university-transition-colors="true" className="text-xs text-primary hover:underline font-bold">
                Forgot password?
              </Link>
            </div>
            <div className="relative">

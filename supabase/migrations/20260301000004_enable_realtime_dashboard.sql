...
BEGIN
  ...
  EXECUTE 'ALTER PUBLICATION supabase_realtime ADD TABLE public.legacy_cms_content';
  ...
  EXECUTE 'ALTER PUBLICATION supabase_realtime ADD TABLE public.book_clubs';
